...
A chess game with javascript. in this javascript chess game you can play with computer, flip board and set position from ([Open in Youtube](https://youtu.be/XaFYLIEq4E8)) by [AsmrProg-YT](https://github.com/AsmrProg-YT/100-days-of-javascript/tree/master/Day%20%2349%20-%20Chess%20Game). 
# FEN Notation
